...
public class MovieServiceImpl implements MovieService {
    ...
    private final String path = "posters";
    ...
    public MovieDto addMovie(MovieDto movieDto, MultipartFile file) throws IOException {
        ...
        // 2. set the value of the filed 'poster' as fileName;
    ...
    public List<MovieDto> getAllMovies() {
        ...
        // 2. iterate through the list, generate the posterUrl for each movie object,
//      // and map to Movie obj
    ...
    public MovieDto updateMovie(Integer movieId, MovieDto movieDto, MultipartFile file) throws IOException {
        // 1. check if the movie object exists with given movie number
        ...
        // 5. save the movie object -> return same movie object
    ...
    public MoviePageResponse getAllMoviesWithPaginationAndSorting(Integer pageNumber, Integer pageSize, String sortBy, String dir) {
        ...
        // TODO: the controller is not sorting correctly in descending order
